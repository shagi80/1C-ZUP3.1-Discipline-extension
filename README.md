...
**Недостатки и разбор решения** кадоровым специалистом в комментариях к статье на Habr: https://habr.com/ru/articles/1084330/
...
![Пример интерфейса](Images/рис2.png)
